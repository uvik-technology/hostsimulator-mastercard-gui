...
namespace HostSimulatorMasterCard
{
    public partial class MainForm : Form
    {
        ...
        byte[] PPS_BAL = new byte[]
        {
            0x03,
            0x07, 0xA0, 0x00, 0x00, 0x00, 0x04, 0x10, 0x10, 0x00, 0x02, 0x02, 0x00,
            0x07, 0xA0, 0x00, 0x00, 0x00, 0x04, 0x30, 0x60, 0x00, 0x02, 0x02, 0x00,
        ...
        byte[] PPS_BAL2 = new byte[]
        {
            ...
            0xDF, 0x81, 0x04, 0x06, 0x11, 0x11, 0x11, 0x22, 0x22, 0x22,  //Balance Read Before Gen AC
            0xDF, 0x81, 0x05, 0x06, 0x33, 0x33, 0x33, 0x44, 0x44, 0x44,  //Balance Read After Gen AC
            0xDF, 0x81, 0x17, 0x01, 0x00,  //Card Data Input Capability
            0xDF, 0x81, 0x18, 0x01, 0x40,  //CVM Capability – CVM Required
            0xDF, 0x81, 0x19, 0x01, 0x08,  //CVM Capability – No CVM Required
            0xDF, 0x81, 0x1C, 0x02, 0x00, 0x00,  //Max Lifetime of Torn Transaction Log Record
        ...
        byte[] PPS_LIMIT_1b_MasterCard = new byte[]
        {
            0x01,
            0x07, 0xA0, 0x00, 0x00, 0x00, 0x04, 0x10, 0x10, 0x00, 0x02, 0x02, 0x00,
            ...
            0xDF, 0x81, 0x19, 0x01, 0x08,
            0xDF, 0x81, 0x1F, 0x01, 0x08,
            0xDF, 0x81, 0x1B, 0x01, 0x00, // Kernel configuration
            0x9f, 0x1D, 0x08, 0x4C, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00,
        ...
        byte[] PPS_LIMIT_1b_Maestro = new byte[]
        {
            0x01,
            0x07, 0xA0, 0x00, 0x00, 0x00, 0x04, 0x30, 0x60, 0x00, 0x02, 0x02, 0x00, //Maestro AID
